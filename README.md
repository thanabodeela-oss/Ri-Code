[APP.py](https://github.com/user-attachments/files/22840827/APP.py)
...
with tab_carton:
    ...
    with col_main:
        ...
        lock = st.radio("🔒 ล็อกแกนตั้ง", ["ไม่ล็อก","w","l","h"], horizontal=True, index=0,
...
with tab_pallet:
    ...
    st.markdown("### 4) จำนวนชั้น (layers)")
